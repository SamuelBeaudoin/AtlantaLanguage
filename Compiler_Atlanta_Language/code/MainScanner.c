...
/* External objects */
extern atlanta_int line; /* Source code line numbers - defined in scanner.c */
extern Token tokenizer(atlanta_nul);
 ...
 * -------------------------------------------------------------
 */
atlanta_nul printScannerError(atlanta_chr* fmt, ...);
atlanta_nul displayScanner(Buffer* ptrBuffer);
atlanta_lng getScannerFilesize(atlanta_chr* fname);
